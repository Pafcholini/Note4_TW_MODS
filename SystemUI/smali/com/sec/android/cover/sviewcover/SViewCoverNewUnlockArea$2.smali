.class Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea$2;
...
.field final synthetic val$cameraNormal:Landroid/graphics/drawable/Drawable;

.field final synthetic val$cameraPessed:Landroid/graphics/drawable/Drawable;


# direct methods
.method constructor <init>(Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    .locals 0

    .prologue
    .line 194
    iput-object p1, p0, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea$2;->this$0:Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;

    iput-object p2, p0, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea$2;->val$cameraPessed:Landroid/graphics/drawable/Drawable;

    iput-object p3, p0, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea$2;->val$cameraNormal:Landroid/graphics/drawable/Drawable;
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    .prologue
    .line 199
    iget-object v4, p0, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea$2;->this$0:Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;
    ...
    iget-object v5, p0, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea$2;->this$0:Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;
    ...
    # invokes: Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->isTalkBackEnabled()Z
    invoke-static {v4}, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->access$300(Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;)Z
    ...
    # setter for: Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->mIsMultiTouched:Z
    invoke-static {v4, v5}, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->access$402(Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;Z)Z
    ...
    iget-object v9, p0, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea$2;->this$0:Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;

    # getter for: Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->mCameraBgPressed:Landroid/widget/ImageView;
    invoke-static {v9}, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->access$900(Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;)Landroid/widget/ImageView;
    ...
    # getter for: Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->mArrowCamera:Landroid/widget/ImageView;
    invoke-static {v9}, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->access$1000(Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;)Landroid/widget/ImageView;
    ...
    # getter for: Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->mCameraCircleInAnimator:Landroid/animation/ValueAnimator;
    invoke-static {v4}, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->access$1400(Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;)Landroid/animation/ValueAnimator;
    ...
    # getter for: Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->mCameraBgNormal:Landroid/widget/ImageView;
    invoke-static {v4}, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->access$1500(Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;)Landroid/widget/ImageView;
    ...
    # getter for: Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->mIsMultiTouched:Z
    invoke-static {v4}, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->access$400(Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;)Z
    ...
    invoke-static {v5}, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->access$1800(Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;)Lcom/sec/android/cover/sviewcover/SViewCoverUnlockCircleEffect;

    move-result-object v5

    iget-object v6, p0, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea$2;->this$0:Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;
    ...
    iget-object v7, p0, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea$2;->this$0:Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;

    # getter for: Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->mCameraBgPressed:Landroid/widget/ImageView;
    invoke-static {v7}, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->access$900(Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;)Landroid/widget/ImageView;
    ...
    iget-object v5, p0, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea$2;->val$cameraPessed:Landroid/graphics/drawable/Drawable;

    # invokes: Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->setCameraIcon(Landroid/graphics/drawable/Drawable;)V
    invoke-static {v4, v5}, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->access$2000(Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v5, p0, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea$2;->val$cameraNormal:Landroid/graphics/drawable/Drawable;
    ...
    # getter for: Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->mCameraCircleOutAnimator:Landroid/animation/ValueAnimator;
    invoke-static {v5}, Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;->access$2100(Lcom/sec/android/cover/sviewcover/SViewCoverNewUnlockArea;)Landroid/animation/ValueAnimator;
    ...
    sget-object v5, Lcom/sec/android/cover/sviewcover/SViewCoverView$PageIndex;->CameraPage:Lcom/sec/android/cover/sviewcover/SViewCoverView$PageIndex;
