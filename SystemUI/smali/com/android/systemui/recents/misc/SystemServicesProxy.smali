...
.method public getTaskThumbnail(I)Landroid/graphics/Bitmap;
    ...
    .line 240
    :cond_1
    iget-object v3, p0, Lcom/android/systemui/recents/misc/SystemServicesProxy;->mCr:Landroid/content/ContentResolver;
    ...
    .line 243
    .local v7, "isPrivateModeState":Z
    :goto_1
    const/4 v8, 0x0

    .line 245
    .local v8, "setDefaultThumbnail":Z
    :try_start_0
    ...
    const-string v5, "Loaded bitmap for task "
    ...
    invoke-virtual {v5, p1}, Landroid/app/ActivityManager;->getTaskTopIsSecretMode(I)Z
    ...
    const-string v5, " PrivateSetting:"
    ...
    invoke-virtual {v3, p1}, Landroid/app/ActivityManager;->getTaskTopIsSecretMode(I)Z
    ...
    const-string v5, ": black thumbnail"
    ...
    .end local v7    # "isPrivateModeState":Z
    .end local v8    # "setDefaultThumbnail":Z
    ...
    .line 252
    .restart local v7    # "isPrivateModeState":Z
    .restart local v8    # "setDefaultThumbnail":Z
    :catch_0
    move-exception v6
    ...
    invoke-static {v3, p1}, Lcom/android/systemui/recents/misc/SystemServicesProxy;->getThumbnail(Landroid/app/ActivityManager;I)Landroid/graphics/Bitmap;
    ...
    .line 270
    invoke-virtual {v10, v2, v2}, Landroid/graphics/Bitmap;->getPixel(II)I
    ...
    .line 271
    iget-object v2, p0, Lcom/android/systemui/recents/misc/SystemServicesProxy;->mBgProtectionCanvas:Landroid/graphics/Canvas;

    sget-object v3, Landroid/graphics/Bitmap$Config;->ARGB_8888:Landroid/graphics/Bitmap$Config;

    invoke-virtual {v10, v3, v0}, Landroid/graphics/Bitmap;->copy(Landroid/graphics/Bitmap$Config;Z)Landroid/graphics/Bitmap;
