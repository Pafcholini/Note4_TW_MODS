...
.method public getUserBadgedIcon(Landroid/graphics/drawable/Drawable;Landroid/os/UserHandle;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v0, v14}, Landroid/app/ApplicationPackageManager;->getBadgeResIdForUser(I)I

    move-result v5

    .line 1167
    .local v5, "badgeResId":I
    if-nez v5, :cond_0
    ...
    invoke-virtual {v0, v14, v5, v15}, Landroid/app/ApplicationPackageManager;->getDrawable(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;)Landroid/graphics/drawable/Drawable;

    move-result-object v4

    .line 1172
    .local v4, "badgeIcon":Landroid/graphics/drawable/Drawable;
    invoke-virtual/range {p2 .. p2}, Landroid/os/UserHandle;->getIdentifier()I
    ...
    invoke-direct {v14, v15, v0, v11, v10}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    invoke-direct {v0, v1, v4, v14, v15}, Landroid/app/ApplicationPackageManager;->getBadgedDrawable(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/Rect;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v14, v15, v11, v10}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V
    ...
    invoke-static {v8, v3, v2, v15}, Landroid/graphics/Bitmap;->createScaledBitmap(Landroid/graphics/Bitmap;IIZ)Landroid/graphics/Bitmap;
    ...
    .line 1190
    .local v13, "resized_icon":Landroid/graphics/drawable/Drawable;
    new-instance v14, Landroid/graphics/Rect;
    ...
    invoke-direct {v14, v15, v0, v3, v2}, Landroid/graphics/Rect;-><init>(IIII)V

    const/4 v15, 0x1

    move-object/from16 v0, p0

    invoke-direct {v0, v13, v4, v14, v15}, Landroid/app/ApplicationPackageManager;->getBadgedDrawable(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/Rect;Z)Landroid/graphics/drawable/Drawable;
    ...
    .end local v13    # "resized_icon":Landroid/graphics/drawable/Drawable;
    :cond_3
    new-instance v14, Landroid/graphics/Rect;
    ...
    .line 1197
    .end local v2    # "app_icon_height":I
    .end local v3    # "app_icon_width":I
    .end local v6    # "badgeht":I
    .end local v7    # "badgewth":I
    .end local v10    # "hiconht":I
    .end local v11    # "iconwth":I
